...
(when (>= emacs-major-version 24)
  ...
  ;; douban-music-mode works only with emacs24  ;; contained in init.el of emacs24-starter-kit
  ;; (load-file "~/.emacs.d/DoubanMusic/douban-music-mode.el")
...
(when (< emacs-major-version 24)
  ...
  ;; contains package assoc, which is obsolete for emacs24
  (require 'unicad)
